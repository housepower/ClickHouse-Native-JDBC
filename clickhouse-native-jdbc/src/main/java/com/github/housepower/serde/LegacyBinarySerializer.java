...
@Deprecated
public class LegacyBinarySerializer implements BinarySerializer {

    private final Switcher<BuffedWriter> switcher;
    private final boolean enableCompress;

    public LegacyBinarySerializer(BuffedWriter writer, boolean enableCompress, @Nullable Compressor compressor) {
