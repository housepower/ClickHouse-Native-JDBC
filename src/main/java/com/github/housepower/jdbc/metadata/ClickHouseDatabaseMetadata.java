...
import static com.github.housepower.jdbc.metadata.TypeUtils.NULLABLE_YES;
...
public class ClickHouseDatabaseMetadata implements DatabaseMetaData {
    ...
    public String getDriverVersion() {
        return String.valueOf(ClickHouseDefines.CLIENT_REVERSION);
    }
